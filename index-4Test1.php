    ...
    <div class="grid_9">
      <h3 class="head1">Contact Form</h3>
            <form id="form" action="#" method="POST">
                      ...
                      <a href="localhost:\\yourhome\site\bat\mailController.php" data-type="submit" class="btn">Send</a>
                      </div>
                      </div>
					  <input type="submit" name="submit" value="Submit" data-type="reset" class="btn">
                      </form>   
    </div>
  </div>
</div>
